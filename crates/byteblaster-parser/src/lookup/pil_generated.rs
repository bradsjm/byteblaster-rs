// @generated by one-time transform from nwws2mqtt Product List
// Source: https://github.com/bradsjm/nwws2mqtt/blob/main/docs/weather/Product%20List.md
...
pub const PIL_GENERATED_AT_UTC: &str = "2026-03-05T03:50:44Z";
pub const PIL_ENTRY_COUNT: usize = 340;

pub static PIL_DESCRIPTIONS: [(&str, &str); PIL_ENTRY_COUNT] = [
