//! File assembly module for EMWIN.
//!
//! This module provides functionality for reconstructing complete files from
//! the segmented data blocks transmitted over the EMWIN protocol.
//!
//! ## File Assembly Process
//!
//! The EMWIN protocol splits files into multiple blocks (segments) that
//! may arrive:
